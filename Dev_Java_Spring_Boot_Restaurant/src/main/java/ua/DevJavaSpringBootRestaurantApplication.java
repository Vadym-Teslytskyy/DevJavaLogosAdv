...
public class DevJavaSpringBootRestaurantApplication extends WebMvcConfigurerAdapter{

	public static void main(String[] args) {
		SpringApplication.run(DevJavaSpringBootRestaurantApplication.class, args);
	}
